...
system.split_fragment_by_identifier(identifier='291_X_PRO', new_names=['PROA', 'PROB'], fragment_definitions=[['C', 'O'], ['N', 'CD', 'HD1', 'HD2', 'CG', 'HG1', 'HG2', 'CB', 'HB1', 'HB2', 'CA', 'HA']])

system.split_fragment_by_identifier(identifier='293_X_PHE', new_names=['PHEA', 'PHEB'], fragment_definitions=[['CA', 'HA', 'N', 'H'], ['C', 'O', 'CB', 'HB1', 'HB2', 'CG', 'CD1', 'HD1', 'CE1', 'HE1', 'CZ', 'HZ', 'CE2', 'HE2', 'CD2', 'HD2']])

system.split_fragment_by_identifier(identifier='117_X_ALA', new_names=['ALAA117', 'ALAB117'], fragment_definitions=[['C', 'O'], ['CA', 'HA', 'N', 'H', 'CB', 'HB1', 'HB2', 'HB3']])

system.split_fragment_by_identifier(identifier='119_X_LEU', new_names=['LEUA119', 'LEUB119'], fragment_definitions=[['N', 'H', 'CA', 'HA'], ['C', 'O', 'CB', 'HB1', 'HB2', 'CG', 'HG', 'CD1', '1HD1', '2HD1', '3HD1', 'CD2', '1HD2', '2HD2', '3HD2']])

# take fragment and put them in core region
core = system.get_fragments_by_name(names=['RET', 'ALAA', 'THRA', 'LEUA', 'GLYA', 'GLHA', 'PROA', 'PHEA', 'ALAA117', 'LEUA119'])
core2 = system.get_fragments_by_identifier(identifiers=['113_X_GLU', '292_X_ALA', '118_X_THR'])
...
'ASN', 'GLN', 'TYR', 'CYS', 'LYS', 'ARG', 'HIS', 'ASP', 'GLU', 'ALAB', 'THRB', 'LEUB', 'GLYB', 'GLHB', 'PROB', 'PHEB', 'ALAB117', 'LEUB119'])
