...
core = system.get_fragments_by_name(names=['RET', 'ALAA', 'THRA', 'LEUA', 'GLYA', 'GLHA', 'PROA', 'PHEA'])
core2 = system.get_fragments_by_identifier(identifiers=['113_X_GLU', '292_X_ALA'])
...
'ASN', 'GLN', 'TYR', 'CYS', 'LYS', 'ARG', 'HIS', 'ASP', 'GLU', 'ALAB', 'THRB', 'LEUB', 'GLYB', 'GLHB', 'PROB', 'PHEB'])
