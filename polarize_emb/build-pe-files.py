...
system = pyframe.MolecularSystem(input_file='./rhod_0.3nm-shell_qmmm.pdb')
...
system.split_fragment_by_identifier(identifier='295_ALA', new_names=['ALAA', 'ALAB'], fragment_definitions=[['C', 'O'], ['CA', 'HA', 'N', 'H', 'CB', 'HB1', 'HB2', 'HB3']])

system.split_fragment_by_identifier(identifier='297_THR', new_names=['THRA', 'THRB'], fragment_definitions=[['N', 'H', 'CA', 'HA'], ['CB', 'HB', 'CG2', '1HG2', '2HG2', '3HG2', 'OG1', 'HG1', 'C', 'O']])

# take fragment and put them in core region
core = system.get_fragments_by_name(names=['RET', 'ALAA', 'THRA'])
#water_QM = system.get_fragments_by_identifier(identifiers=['232_SOL', '236_SOL', '241_SOL', '251_SOL', '256_SOL'])

#core.update(water_QM)

#core_capp = system.get_fragments_by_name(names)
system.set_core_region(core, basis='aug-cc-pVDZ')
...
'ASN', 'GLN', 'TYR', 'CYS', 'LYS', 'ARG', 'HIS', 'ASP', 'GLU', 'ALAB', 'THRB'])
...
multipole_basis='aug-cc-pVDZ', use_polarizabilities=True,

polarizability_basis='aug-cc-pVDZ', multipole_program='molcas', 
...
multipole_order=2, multipole_basis='aug-cc-pVDZ', 

use_polarizabilities=True, polarizability_basis='aug-cc-pVDZ', 
...
multipole_order=0, multipole_basis='aug-cc-pVDZ',
...
project.create_embedding_potential_DG(system)
##
#### Create pot file
